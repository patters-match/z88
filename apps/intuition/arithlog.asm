    ...
    ; Routine defined in 'Stdinstr_asm':
...
; ******************************************************************************
;
; ADD  IX | IY,DE      instruction          2 byte
;
...
; ******************************************************************************
;
; ADD  IX | IY ,SP      instruction               2 byte
;
