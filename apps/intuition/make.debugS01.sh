...
# *************************************************************************************
# Intuition UNIX/LINUX make script to build executable for segment 1 address space
...
../../csrc/mpm/mpm -b -DSEGMENT3 -r4000 -odebugS01.bin -I../oz/sysdef -l../stdlib/standard.lib @debug
