; -----------------------------------------------------------------------------
; Bank 2 @ S3           ROM offset $9800-$A4FF
;
; $Id$
; -----------------------------------------------------------------------------
...
.mod_1
        ld      a, h
        xor     d                               ; A7 set if signs differ
        bit     7, h                            ; Fs=1 if HLhl negative
        ex      af, af'
        bit     7, h
...
.ReadByteIX
        ...
        ld      (BLSC_SR1), a                   ; bind iy+3 into S1
        out     (BL_SR1), a
