...
rm -f *.err *.sym *.def *.lst *.obj *.bin *.map
../../../tools/mpm/mpm -g -DOZ_SLOT$1 -I../../def @debug0a
../../../tools/mpm/mpm -bg -DOZ_SLOT$1 -I../../def @debug0b
../../../tools/mpm/mpm -b -DOZ_SLOT$1 -DGET_UPPER_8K_REFS -I../../def @debug0a
