...
# ********************************************************************************************
# Intuition make script (Unix/Linux) to build integrated executable for OZ OZ 4.2 (or later),
...
cd ../../../stdlib; ./makelib.sh; cd ../oz/apps/intuition
...
../../../tools/mpm/mpm -bg -DOZ_SLOT$1 -DOZ_INTUITION -DINT_SEGM0 -DSEGMENT3 -I../../def -l../../../stdlib/standard.lib @debug0b
../../../tools/mpm/mpm -b -DOZ_SLOT$1 -DOZ_INTUITION -DINT_SEGM0 -DSEGMENT3 -I../../def -l../../../stdlib/standard.lib @debug0a
