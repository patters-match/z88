...
defc	IDF_B_WEEKDAY		=0
defc	IDF_B_MONTHDAY		=1
defc	IDF_B_MONTHNUM		=2
defc	IDF_B_ORDINAL		=3
defc	IDF_B_YEAR		=4
defc	IDF_B_ADBC		=5
defc	IDF_B_MONTHALPHA	=6
...
.pdt_8
	...
	ld	c, l
	push	de
	ld	a, $21			; output 2 digits
	bit	7, (iy+OSFrame_A)	; output century?
	jr	z, pdt_9
	ld	h, b
	ld	l, c
	ld	de, 1000		; !! doesn't work after year 2000! use divu16, take remainder
	xor	a			; no formatting
	sbc	hl, de
	jr	nc, pdt_9
	ld	a, $41			; output 4 digits
.pdt_9
	ld	hl, 2			; convert BC
...
;	movbe data from filter to DE(in)
