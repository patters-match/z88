...
public final class Blink {
    ...
    /**
     * Acknowledge Main Blink Interrrupts (INT): BIT 6, A19 Acknowledge active
     * high on A19
     */
    public static final int BM_ACKA19 = 0x40;
    /**
     * Acknowledge Main Blink Interrrupts (INT): BIT 5, FLAP Acknowledge Flap
     * interrupts
     */
    public static final int BM_ACKFLAP = 0x20;
    /**
     * Acknowledge Main Blink Interrrupts (INT): BIT 3, BTL Acknowledge battery
     * low interrupt
     */
    public static final int BM_ACKBTL = 0x08;
    /**
     * Acknowledge Main Blink Interrrupts (INT): BIT 2, KEY Acknowledge keyboard
     * interrupt
     */
    public static final int BM_ACKKEY = 0x04;
    /**
     * Acknowledge Main Blink Interrrupts (INT): Bit 0, TIME Acknowledge TIME
     * interrupt
     */
    ...
    /**
     * Set Main Blink Interrupt Status (STA). (Used for restore machine state
     * functionality)
     *
     * <PRE>
     * Bit 7, FLAPOPEN, If set, flap open, else flap closed
    ...
    /**
     * Set Timer Interrupt Status (TSTA). (Used for restore machine state
     * functionality)
     *
     * <PRE>
     * BIT 2, MIN, Set if minute interrupt has occurred
    ...
    /**
     * set current Real Time Clock TIM3 register. (Used for restore machine
     * state functionality)
     */
    ...
    /**
     * set current Real Time Clock TIM4 register. (Used for restore machine
     * state functionality)
     */
     ...
     * (2K size), containing char info about screen) If this register is 0, then
     * the system cannot render the pixel screen.
     */
    ...
    /**
     * This method is called by Blink's own Rtc thread, HW or both SHIFT keys
     * are pressed - to signal an interrupt or out-of-coma state. It will awake
     * the Z80Processor thread (who is waiting for Blink to signal out-of-coma).
     */
