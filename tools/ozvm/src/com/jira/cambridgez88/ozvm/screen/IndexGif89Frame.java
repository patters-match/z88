 ...
 * cellular automaton). <p> Objects of this class are normally added to a
 * Gif89Encoder object that has been provided with an explicit color table at
 * construction. While you may also add them to "auto-map" encoders without an
 * exception being thrown, there obviously must be at least one DirectGif89Frame
