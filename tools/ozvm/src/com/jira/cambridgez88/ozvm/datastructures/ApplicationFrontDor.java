 ...
 * is location at offset $3FC0 in the top bank of an external card, or at
 * bank $1F in slot 0.
 * 
 * The contents of the location is read without interpretation. It is the
 * responsibility of the appication using this object to identify an 
 * application card header before using this class to properly recieve
 * valid pointers.
 */
public class ApplicationFrontDor {
	...
	/**
	 * Extended, absolute address pointer to Help Front DOR, or none
	 * (relative pointer is only available in actual memory of the card)
	 */
	private int helpDor;
