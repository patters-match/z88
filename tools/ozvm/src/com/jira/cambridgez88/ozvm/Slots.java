...
public class Slots extends JPanel {
        ...
        if (rom0Button == null) {
            ...
            rom0Button.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (JOptionPane.showConfirmDialog(Slots.this, installRomMsg, "Replace OZ operating system ROM", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
        ...
        if (ram0Button == null) {
            ...
            ram0Button.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (JOptionPane.showConfirmDialog(Slots.this, installRamMsg, "Replace internal RAM memory", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
    ...
    private void insertCard(JButton slotButton, int slotNo) {
        ...
        if (lastRemovedCard[slotNo] != null) // The user may choose to re-insert a previously removed card
        {
    ...
    private JCheckBox getReInsertCardCopyCheckBox() {
        if (insertCardCopyCheckBox == null) {
            ...
            insertCardCopyCheckBox.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (insertCardCopyCheckBox.isSelected() == true) // disable all other insert-dialog features -
                    // the user wants to re-insert a previously removed card
                    {
                        insertCardDialogAccessibility(false);
                    } else // re-enable insert-card-dialog features -
        ...
        if (browseFilesButton == null) {
            ...
            browseFilesButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    fileAreaChooser.setDialogTitle("Import files into Card File Area");
                    fileAreaChooser.setMultiSelectionEnabled(true);
                    fileAreaChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);

                    int returnVal = fileAreaChooser.showOpenDialog(Slots.this.getParent());
                    if (returnVal == JFileChooser.APPROVE_OPTION) {
        ...
        if (browseAppsButton == null) {
            ...
            browseAppsButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    cardImageFileChooser.setDialogTitle("Load eprom and/or 16K bank file images into card");
                    cardImageFileChooser.setMultiSelectionEnabled(true);
                    cardImageFileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
    ...
    /**
     * Extended Popup menu with context sensitive menu items that enables the
     * user to import/export files to the file area of the card.
     */
    private class CardPopupMenu extends JPopupMenu {
        ...
        /**
         * If the card contains a file area, a popup menu is displayed at the
         * position x,y in the coordinate space of the component invoker.
         *
         * @param invoker
         * @param x
         * @param y
