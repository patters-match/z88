...
public class Gif89Encoder {
  ...
  public void setUniformDelay(int interval)
  {
	 ...
	 * internal Vector storage (a large, or long animation with 
	 * hundreds of frames will properly not fit within the Java Heap!).
	 * 
	 * When the last frame has been written, use: <pre>  
