...
/**
 * This class represents the 16Kb Generic Flash Memory Bank on an AMD 29FxxxB and
 * compatible chips (STMicroelectronics 29FxxxB and D series).
 *
 ...
 * chip command mode programming, since the Z88 Flash Cards only responds to those
			...
			if (isCommandExecuting == false) {
				...
				switch(executingCommandCode) {
					...
					case 0x90: // Autoselect Command
						...
						switch(addr) {
							case 0: return getManufacturerCode();	// XX00 = Manufacturer Code
							case 1: return getDeviceCode();			// XX01 = Device Code
