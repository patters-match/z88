...
public abstract class Z80 {
	...
	public final void execute() {
		...
		/* LD (**),A/A,(**) */
		case 2:    /* LD (BC),A */
		{ writeByte( BC(), A() ); local_tstates += ( 7 ); break; }
		case 10:    /* LD A,(BC) */
		{ A( readByte( BC() ) ); local_tstates += ( 7 ); break; }
		case 18:    /* LD (DE),A */
		{ writeByte( DE(), A() ); local_tstates += ( 7 ); break; }
		case 26:    /* LD A,(DE) */
		{ A( readByte( DE() ) ); local_tstates += ( 7 ); break; }
		case 34:    /* LD (nn),HL */
		{ pokew( nxtpcw(), HL() ); local_tstates += ( 16 ); break; }
		case 42:    /* LD HL,(nn) */
		{ HL( peekw( nxtpcw() ) ); local_tstates += ( 16 ); break; }
		case 50:    /* LD (nn),A */
		{ writeByte( nxtpcw(), A() ); local_tstates += ( 13 ); break; }
		case 58:    /* LD A,(nn) */
		{ A( readByte( nxtpcw() ) ); local_tstates += ( 13 ); break; }
		...
		case 70:    /* LD B,(HL) */
		{ B( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 71:    /* LD B,A */
		...
		case 78:    /* LD C,(HL) */
		{ C( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 79:    /* LD C,A */
		...
		case 86:    /* LD D,(HL) */
		{ D( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 87:    /* LD D,A */
		...
		case 94:    /* LD E,(HL) */
		{ E( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 95:    /* LD E,A */
		...
		case 102:    /* LD H,(HL) */
		{ H( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 103:    /* LD H,A */
		...
		{ local_tstates += ( 4 ); break; }
		case 110:    /* LD L,(HL) */
		{ L( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 111:    /* LD L,A */
		{ L( A() ); local_tstates += ( 4 ); break; }

		/* LD (HL),* */
		case 112:    /* LD (HL),B */
		{ writeByte( HL(), B() ); local_tstates += ( 7 ); break; }
		case 113:    /* LD (HL),C */
		{ writeByte( HL(), C() ); local_tstates += ( 7 ); break; }
		case 114:    /* LD (HL),D */
		{ writeByte( HL(), D() ); local_tstates += ( 7 ); break; }
		case 115:    /* LD (HL),E */
		{ writeByte( HL(), E() ); local_tstates += ( 7 ); break; }
		case 116:    /* LD (HL),H */
		{ writeByte( HL(), H() ); local_tstates += ( 7 ); break; }
		case 117:    /* LD (HL),L */
		{ writeByte( HL(), L() ); local_tstates += ( 7 ); break; }
		case 118:    /* HALT */
		{ 
		...
		case 119:    /* LD (HL),A */
		{ writeByte( HL(), A() ); local_tstates += ( 7 ); break; }
		...
		case 126:    /* LD A,(HL) */
		{ A( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 127:    /* LD A,A */
		{ local_tstates += ( 4 ); break; }
		...
		case 134:    /* ADD A,(HL) */
		{ add_a( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 135:    /* ADD A,A */
		...
		case 142:    /* ADC A,(HL) */
		{ adc_a( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 143:    /* ADC A,A */
		...
		case 150:    /* SUB (HL) */
		{ sub_a( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 151:    /* SUB A() */
		...
		case 158:    /* SBC A,(HL) */
		{ sbc_a( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 159:    /* SBC A,A */
		...
		case 166:    /* AND (HL) */
		{ and_a( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 167:    /* AND A() */
		...
		case 174:    /* XOR (HL) */
		{ xor_a( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 175:    /* XOR A() */
		...
		case 182:    /* OR (HL) */
		{ or_a( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 183:    /* OR A() */
		...
		case 190:    /* CP (HL) */
		{ cp_a( readByte( HL() ) ); local_tstates += ( 7 ); break; }
		case 191:    /* CP A() */
	...
	private final int execute_cb() {
		...
		{ bit( 0x01, L() ); return ( 8 ); }
		case  70:	/* BIT 0,(HL) */
		{ bit( 0x01, readByte( HL() ) ); return ( 12 ); }
		case  71:	/* BIT 0,A */
		{ bit( 0x01, A() ); return ( 8 ); }
		...
		{ bit( 0x02, L() ); return ( 8 ); }
		case  78:	/* BIT 1,(HL) */
		{ bit( 0x02, readByte( HL() ) ); return ( 12 ); }
		case  79:	/* BIT 1,A */
		{ bit( 0x02, A() ); return ( 8 ); }
		...
		{ bit( 0x04, L() ); return ( 8 ); }
		case  86:	/* BIT 2,(HL) */
		{ bit( 0x04, readByte( HL() ) ); return ( 12 ); }
		case  87:	/* BIT 2,A */
		{ bit( 0x04, A() ); return ( 8 ); }
		...
		{ bit( 0x08, L() ); return ( 8 ); }
		case  94:	/* BIT 3,(HL) */
		{ bit( 0x08, readByte( HL() ) ); return ( 12 ); }
		case  95:	/* BIT 3,A */
		{ bit( 0x08, A() ); return ( 8 ); }
		...
		{ bit( 0x10, L() ); return ( 8 ); }
		case 102:	/* BIT 4,(HL) */
		{ bit( 0x10, readByte( HL() ) ); return ( 12 ); }
		case 103:	/* BIT 4,A */
		{ bit( 0x10, A() ); return ( 8 ); }
		...
		{ bit( 0x20, L() ); return ( 8 ); }
		case 110:	/* BIT 5,(HL) */
		{ bit( 0x20, readByte( HL() ) ); return ( 12 ); }
		case 111:	/* BIT 5,A */
		{ bit( 0x20, A() ); return ( 8 ); }
		...
		{ bit( 0x40, L() ); return ( 8 ); }
		case 118:	/* BIT 6,(HL) */
		{ bit( 0x40, readByte( HL() ) ); return ( 12 ); }
		case 119:	/* BIT 6,A */
		{ bit( 0x40, A() ); return ( 8 ); }
		...
		{ bit( 0x80, L() ); return ( 8 ); }
		case 126:	/* BIT 7,(HL) */
		{ bit( 0x80, readByte( HL() ) ); return ( 12 ); }
		case 127:	/* BIT 7,A */
		{ bit( 0x80, A() ); return ( 8 ); }
	...
	private final int execute_id() {
		...
		case 54: /* LD (ID+d),n */
		{ int z = ID_d(); writeByte(z,nxtpcb()); return ( 19 ); }
		...
		{ return ( 8 ); }
		case 110: /* LD L,(ID+d) */
		{ L( readByte( ID_d() ) ); return ( 19 ); }
		case 111: /* LD IDL,A */
		{ IDL( A() ); return ( 8 ); }

		case 112: /* LD (ID+d),B */
		{ writeByte( ID_d(), B() ); return ( 19 ); }
		case 113: /* LD (ID+d),C */
		{ writeByte( ID_d(), C() ); return ( 19 ); }
		case 114: /* LD (ID+d),D */
		{ writeByte( ID_d(), D() ); return ( 19 ); }
		case 115: /* LD (ID+d),E */
		{ writeByte( ID_d(), E() ); return ( 19 ); }
		case 116: /* LD (ID+d),H */
		{ writeByte( ID_d(), H() ); return ( 19 ); }
		case 117: /* LD (ID+d),L */
		{ writeByte( ID_d(), L() ); return ( 19 ); }
		case 119: /* LD (ID+d),A */
		{ writeByte( ID_d(), A() ); return ( 19 ); }
	...
	private final void execute_id_cb(int op, int z) {
		...
		case   0:	/* RLC B */
		{ B( op = rlc( readByte( z ) ) ); writeByte( z, op ); return; }
		case   1:	/* RLC C */
		{ C( op = rlc( readByte( z ) ) ); writeByte( z, op ); return; }
		case   2:	/* RLC D */
		{ D( op = rlc( readByte( z ) ) ); writeByte( z, op ); return; }
		case   3:	/* RLC E */
		{ E( op = rlc( readByte( z ) ) ); writeByte( z, op ); return; }
		case   4:	/* RLC H */
		{ H( op = rlc( readByte( z ) ) ); writeByte( z, op ); return; }
		case   5:	/* RLC L */
		{ L( op = rlc( readByte( z ) ) ); writeByte( z, op ); return; }
		case   6:	/* RLC (HL) */
		{ writeByte( z, rlc( readByte( z ) ) ); return; }
		case   7:	/* RLC A */
		{ A( op = rlc( readByte( z ) ) ); writeByte( z, op ); return; }

		case   8:	/* RRC B */
		{ B( op = rrc( readByte( z ) ) ); writeByte( z, op ); return; }
		case   9:	/* RRC C */
		{ C( op = rrc( readByte( z ) ) ); writeByte( z, op ); return; }
		case  10:	/* RRC D */
		{ D( op = rrc( readByte( z ) ) ); writeByte( z, op ); return; }
		case  11:	/* RRC E */
		{ E( op = rrc( readByte( z ) ) ); writeByte( z, op ); return; }
		case  12:	/* RRC H */
		{ H( op = rrc( readByte( z ) ) ); writeByte( z, op ); return; }
		case  13:	/* RRC L */
		{ L( op = rrc( readByte( z ) ) ); writeByte( z, op ); return; }
		case  14:	/* RRC (HL) */
		{ writeByte( z, rrc( readByte( z ) ) ); return; }
		case  15:	/* RRC A */
		{ A( op = rrc( readByte( z ) ) ); writeByte( z, op ); return; }

		case  16:	/* RL B */
		{ B( op = rl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  17:	/* RL C */
		{ C( op = rl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  18:	/* RL D */
		{ D( op = rl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  19:	/* RL E */
		{ E( op = rl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  20:	/* RL H */
		{ H( op = rl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  21:	/* RL L */
		{ L( op = rl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  22:	/* RL (HL) */
		{ writeByte( z, rl( readByte( z ) ) ); return; }
		case  23:	/* RL A */
		{ A( op = rl( readByte( z ) ) ); writeByte( z, op ); return; }

		case  24:	/* RR B */
		{ B( op = rr( readByte( z ) ) ); writeByte( z, op ); return; }
		case  25:	/* RR C */
		{ C( op = rr( readByte( z ) ) ); writeByte( z, op ); return; }
		case  26:	/* RR D */
		{ D( op = rr( readByte( z ) ) ); writeByte( z, op ); return; }
		case  27:	/* RR E */
		{ E( op = rr( readByte( z ) ) ); writeByte( z, op ); return; }
		case  28:	/* RR H */
		{ H( op = rr( readByte( z ) ) ); writeByte( z, op ); return; }
		case  29:	/* RR L */
		{ L( op = rr( readByte( z ) ) ); writeByte( z, op ); return; }
		case  30:	/* RR (HL) */
		{ writeByte( z, rr( readByte( z ) ) ); return; }
		case  31:	/* RR A */
		{ A( op = rr( readByte( z ) ) ); writeByte( z, op ); return; }

		case  32:	/* SLA B */
		{ B( op = sla( readByte( z ) ) ); writeByte( z, op ); return; }
		case  33:	/* SLA C */
		{ C( op = sla( readByte( z ) ) ); writeByte( z, op ); return; }
		case  34:	/* SLA D */
		{ D( op = sla( readByte( z ) ) ); writeByte( z, op ); return; }
		case  35:	/* SLA E */
		{ E( op = sla( readByte( z ) ) ); writeByte( z, op ); return; }
		case  36:	/* SLA H */
		{ H( op = sla( readByte( z ) ) ); writeByte( z, op ); return; }
		case  37:	/* SLA L */
		{ L( op = sla( readByte( z ) ) ); writeByte( z, op ); return; }
		case  38:	/* SLA (HL) */
		{ writeByte( z, sla( readByte( z ) ) ); return; }
		case  39:	/* SLA A */
		{ A( op = sla( readByte( z ) ) ); writeByte( z, op ); return; }

		case  40:	/* SRA B */
		{ B( op = sra( readByte( z ) ) ); writeByte( z, op ); return; }
		case  41:	/* SRA C */
		{ C( op = sra( readByte( z ) ) ); writeByte( z, op ); return; }
		case  42:	/* SRA D */
		{ D( op = sra( readByte( z ) ) ); writeByte( z, op ); return; }
		case  43:	/* SRA E */
		{ E( op = sra( readByte( z ) ) ); writeByte( z, op ); return; }
		case  44:	/* SRA H */
		{ H( op = sra( readByte( z ) ) ); writeByte( z, op ); return; }
		case  45:	/* SRA L */
		{ L( op = sra( readByte( z ) ) ); writeByte( z, op ); return; }
		case  46:	/* SRA (HL) */
		{ writeByte( z, sra( readByte( z ) ) ); return; }
		case  47:	/* SRA A */
		{ A( op = sra( readByte( z ) ) ); writeByte( z, op ); return; }

		case  48:	/* SLS B */
		{ B( op = sls( readByte( z ) ) ); writeByte( z, op ); return; }
		case  49:	/* SLS C */
		{ C( op = sls( readByte( z ) ) ); writeByte( z, op ); return; }
		case  50:	/* SLS D */
		{ D( op = sls( readByte( z ) ) ); writeByte( z, op ); return; }
		case  51:	/* SLS E */
		{ E( op = sls( readByte( z ) ) ); writeByte( z, op ); return; }
		case  52:	/* SLS H */
		{ H( op = sls( readByte( z ) ) ); writeByte( z, op ); return; }
		case  53:	/* SLS L */
		{ L( op = sls( readByte( z ) ) ); writeByte( z, op ); return; }
		case  54:	/* SLS (HL) */
		{ writeByte( z, sls( readByte( z ) ) ); return; }
		case  55:	/* SLS A */
		{ A( op = sls( readByte( z ) ) ); writeByte( z, op ); return; }

		case  56:	/* SRL B */
		{ B( op = srl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  57:	/* SRL C */
		{ C( op = srl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  58:	/* SRL D */
		{ D( op = srl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  59:	/* SRL E */
		{ E( op = srl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  60:	/* SRL H */
		{ H( op = srl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  61:	/* SRL L */
		{ L( op = srl( readByte( z ) ) ); writeByte( z, op ); return; }
		case  62:	/* SRL (HL) */
		{ writeByte( z, srl( readByte( z ) ) ); return; }
		case  63:	/* SRL A */
		{ A( op = srl( readByte( z ) ) ); writeByte( z, op ); return; }
		...
		case 126:	/* BIT 7,B */
		case 127:	/* BIT 7,B */
		{ bit( 0x80, readByte( z ) ); return; }

		case 128:	/* RES 0,B */
		{ B( op = res( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 129:	/* RES 0,C */
		{ C( op = res( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 130:	/* RES 0,D */
		{ D( op = res( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 131:	/* RES 0,E */
		{ E( op = res( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 132:	/* RES 0,H */
		{ H( op = res( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 133:	/* RES 0,L */
		{ L( op = res( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 134:	/* RES 0,(HL) */
		{ writeByte( z, res( 0x01, readByte( z ) ) ); return; }
		case 135:	/* RES 0,A */
		{ A( op = res( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }

		case 136:	/* RES 1,B */
		{ B( op = res( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 137:	/* RES 1,C */
		{ C( op = res( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 138:	/* RES 1,D */
		{ D( op = res( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 139:	/* RES 1,E */
		{ E( op = res( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 140:	/* RES 1,H */
		{ H( op = res( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 141:	/* RES 1,L */
		{ L( op = res( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 142:	/* RES 1,(HL) */
		{ writeByte( z, res( 0x02, readByte( z ) ) ); return; }
		case 143:	/* RES 1,A */
		{ A( op = res( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }

		case 144:	/* RES 2,B */
		{ B( op = res( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 145:	/* RES 2,C */
		{ C( op = res( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 146:	/* RES 2,D */
		{ D( op = res( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 147:	/* RES 2,E */
		{ E( op = res( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 148:	/* RES 2,H */
		{ H( op = res( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 149:	/* RES 2,L */
		{ L( op = res( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 150:	/* RES 2,(HL) */
		{ writeByte( z, res( 0x04, readByte( z ) ) ); return; }
		case 151:	/* RES 2,A */
		{ A( op = res( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }

		case 152:	/* RES 3,B */
		{ B( op = res( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 153:	/* RES 3,C */
		{ C( op = res( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 154:	/* RES 3,D */
		{ D( op = res( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 155:	/* RES 3,E */
		{ E( op = res( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 156:	/* RES 3,H */
		{ H( op = res( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 157:	/* RES 3,L */
		{ L( op = res( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 158:	/* RES 3,(HL) */
		{ writeByte( z, res( 0x08, readByte( z ) ) ); return; }
		case 159:	/* RES 3,A */
		{ A( op = res( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }

		case 160:	/* RES 4,B */
		{ B( op = res( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 161:	/* RES 4,C */
		{ C( op = res( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 162:	/* RES 4,D */
		{ D( op = res( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 163:	/* RES 4,E */
		{ E( op = res( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 164:	/* RES 4,H */
		{ H( op = res( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 165:	/* RES 4,L */
		{ L( op = res( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 166:	/* RES 4,(HL) */
		{ writeByte( z, res( 0x10, readByte( z ) ) ); return; }
		case 167:	/* RES 4,A */
		{ A( op = res( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }

		case 168:	/* RES 5,B */
		{ B( op = res( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 169:	/* RES 5,C */
		{ C( op = res( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 170:	/* RES 5,D */
		{ D( op = res( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 171:	/* RES 5,E */
		{ E( op = res( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 172:	/* RES 5,H */
		{ H( op = res( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 173:	/* RES 5,L */
		{ L( op = res( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 174:	/* RES 5,(HL) */
		{ writeByte( z, res( 0x20, readByte( z ) ) ); return; }
		case 175:	/* RES 5,A */
		{ A( op = res( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }

		case 176:	/* RES 6,B */
		{ B( op = res( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 177:	/* RES 6,C */
		{ C( op = res( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 178:	/* RES 6,D */
		{ D( op = res( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 179:	/* RES 6,E */
		{ E( op = res( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 180:	/* RES 6,H */
		{ H( op = res( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 181:	/* RES 6,L */
		{ L( op = res( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 182:	/* RES 6,(HL) */
		{ writeByte( z, res( 0x40, readByte( z ) ) ); return; }
		case 183:	/* RES 6,A */
		{ A( op = res( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }

		case 184:	/* RES 7,B */
		{ B( op = res( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 185:	/* RES 7,C */
		{ C( op = res( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 186:	/* RES 7,D */
		{ D( op = res( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 187:	/* RES 7,E */
		{ E( op = res( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 188:	/* RES 7,H */
		{ H( op = res( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 189:	/* RES 7,L */
		{ L( op = res( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 190:	/* RES 7,(HL) */
		{ writeByte( z, res( 0x80, readByte( z ) ) ); return; }
		case 191:	/* RES 7,A */
		{ A( op = res( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }

		case 192:	/* SET 0,B */
		{ B( op = set( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 193:	/* SET 0,C */
		{ C( op = set( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 194:	/* SET 0,D */
		{ D( op = set( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 195:	/* SET 0,E */
		{ E( op = set( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 196:	/* SET 0,H */
		{ H( op = set( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 197:	/* SET 0,L */
		{ L( op = set( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }
		case 198:	/* SET 0,(HL) */
		{ writeByte( z, set( 0x01, readByte( z ) ) ); return; }
		case 199:	/* SET 0,A */
		{ A( op = set( 0x01, readByte( z ) ) ); writeByte( z, op ); return; }

		case 200:	/* SET 1,B */
		{ B( op = set( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 201:	/* SET 1,C */
		{ C( op = set( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 202:	/* SET 1,D */
		{ D( op = set( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 203:	/* SET 1,E */
		{ E( op = set( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 204:	/* SET 1,H */
		{ H( op = set( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 205:	/* SET 1,L */
		{ L( op = set( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }
		case 206:	/* SET 1,(HL) */
		{ writeByte( z, set( 0x02, readByte( z ) ) ); return; }
		case 207:	/* SET 1,A */
		{ A( op = set( 0x02, readByte( z ) ) ); writeByte( z, op ); return; }

		case 208:	/* SET 2,B */
		{ B( op = set( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 209:	/* SET 2,C */
		{ C( op = set( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 210:	/* SET 2,D */
		{ D( op = set( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 211:	/* SET 2,E */
		{ E( op = set( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 212:	/* SET 2,H */
		{ H( op = set( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 213:	/* SET 2,L */
		{ L( op = set( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }
		case 214:	/* SET 2,(HL) */
		{ writeByte( z, set( 0x04, readByte( z ) ) ); return; }
		case 215:	/* SET 2,A */
		{ A( op = set( 0x04, readByte( z ) ) ); writeByte( z, op ); return; }

		case 216:	/* SET 3,B */
		{ B( op = set( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 217:	/* SET 3,C */
		{ C( op = set( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 218:	/* SET 3,D */
		{ D( op = set( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 219:	/* SET 3,E */
		{ E( op = set( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 220:	/* SET 3,H */
		{ H( op = set( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 221:	/* SET 3,L */
		{ L( op = set( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }
		case 222:	/* SET 3,(HL) */
		{ writeByte( z, set( 0x08, readByte( z ) ) ); return; }
		case 223:	/* SET 3,A */
		{ A( op = set( 0x08, readByte( z ) ) ); writeByte( z, op ); return; }

		case 224:	/* SET 4,B */
		{ B( op = set( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 225:	/* SET 4,C */
		{ C( op = set( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 226:	/* SET 4,D */
		{ D( op = set( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 227:	/* SET 4,E */
		{ E( op = set( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 228:	/* SET 4,H */
		{ H( op = set( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 229:	/* SET 4,L */
		{ L( op = set( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }
		case 230:	/* SET 4,(HL) */
		{ writeByte( z, set( 0x10, readByte( z ) ) ); return; }
		case 231:	/* SET 4,A */
		{ A( op = set( 0x10, readByte( z ) ) ); writeByte( z, op ); return; }

		case 232:	/* SET 5,B */
		{ B( op = set( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 233:	/* SET 5,C */
		{ C( op = set( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 234:	/* SET 5,D */
		{ D( op = set( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 235:	/* SET 5,E */
		{ E( op = set( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 236:	/* SET 5,H */
		{ H( op = set( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 237:	/* SET 5,L */
		{ L( op = set( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }
		case 238:	/* SET 5,(HL) */
		{ writeByte( z, set( 0x20, readByte( z ) ) ); return; }
		case 239:	/* SET 5,A */
		{ A( op = set( 0x20, readByte( z ) ) ); writeByte( z, op ); return; }

		case 240:	/* SET 6,B */
		{ B( op = set( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 241:	/* SET 6,C */
		{ C( op = set( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 242:	/* SET 6,D */
		{ D( op = set( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 243:	/* SET 6,E */
		{ E( op = set( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 244:	/* SET 6,H */
		{ H( op = set( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 245:	/* SET 6,L */
		{ L( op = set( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }
		case 246:	/* SET 6,(HL) */
		{ writeByte( z, set( 0x40, readByte( z ) ) ); return; }
		case 247:	/* SET 6,A */
		{ A( op = set( 0x40, readByte( z ) ) ); writeByte( z, op ); return; }

		case 248:	/* SET 7,B */
		{ B( op = set( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 249:	/* SET 7,C */
		{ C( op = set( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 250:	/* SET 7,D */
		{ D( op = set( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 251:	/* SET 7,E */
		{ E( op = set( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 252:	/* SET 7,H */
		{ H( op = set( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 253:	/* SET 7,L */
		{ L( op = set( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
		case 254:	/* SET 7,(HL) */
		{ writeByte( z, set( 0x80, readByte( z ) ) ); return; }
		case 255:	/* SET 7,A */
		{ A( op = set( 0x80, readByte( z ) ) ); writeByte( z, op ); return; }
