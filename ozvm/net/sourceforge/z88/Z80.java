 ...
 *
 * Memory architecture logic to read/write bytes in Z80 have been declared as
 * abstract. Halt instruction logic defined as abstract. Calculated T-state
 * periodic interrupt logic replaced by external signal that an interrupt has
 * occurred. An external Java thread will provide the interrupt signal.
 *
