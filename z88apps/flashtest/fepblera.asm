...
;***************************************************************************************************
     ...
     XREF FlashCardId         ; Identify Flash Memory Chip in slot C

     XDEF FlashBlockErase
...
.FlashBlockErase
                    ...
                    CALL FlashCardId         ; poll for card information in slot C (returns B = total banks of card)
