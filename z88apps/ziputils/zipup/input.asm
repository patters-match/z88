...
.optcycles
        defb    @01001011       ; Delete (Off/On/Ask)
        defb    @01100011       ; Compress (Off/On)
        defb    @01100011       ; Paths (Off/On)

; Mail ID

.mail_name      defm    "NAME", 0

; Cursor on/off

.cursor_on      defm    1, "2+C", 0
.cursor_off     defm    1, "2-C", 0
