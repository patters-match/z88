...
..\..\tools\mpm\mpm -b -I..\..\oz\sysdef -l..\..\stdlib\standard.lib @romupdate
...
java -jar ..\..\tools\ozvm\z88.jar crd2 16 27c romupdate.epr crd3 1024 29f ..\flashstore\flashstore.epr
