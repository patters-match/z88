...
public:
    ...
    retcode receiveFiles(const QString &z88Filenames, QString hostpath, bool hostPath_isdir);   // receive one or more files from Z88 to host using EazyLink protocol
