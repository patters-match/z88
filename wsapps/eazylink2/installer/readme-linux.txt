...
When you start Eazylink the first time on your Linux desktop,
you might not see any serial port devices in the device list.

Please log out of your desktop, then re-login.

The Installer has assigned your login-user to the "dialout"
group - and it might not have taken effect until you have
done a re-login into your desktop.
